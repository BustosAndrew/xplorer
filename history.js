...
import { Font } from 'expo'; // Assuming you're using Expo
    ...
    const loadFonts = async () => {
      try {
        await Font.loadAsync({
          'Jura': require('./assets/fonts/Jura-Regular.ttf'), // Replace with your font file path (if using Jura font)
        });
        setFontsLoaded(true);
      } catch (error) {
        console.error('Error loading fonts:', error);
        // Handle the error gracefully, e.g., display a fallback message
      }
    };
    loadFonts();
  }, []);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        <Image source={require('./assets/arc_pavilion.png')} style={styles.image} />
      </View>
